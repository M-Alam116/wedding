...
export default function Working() {
  return (
    <div className="container bg-secondaryBg py-[50px] px-[5px]">
      <div>
        <h1 className="heading text-center">HOW IT WORKS</h1>
      </div>

      <div className="flex flex-wrap justify-center gap-[80px] lg:gap-[30px] mt-[50px]">
        <div className="relative z-1 flex flex-col justify-center items-center border-[2px] border-gray-300 shadow-xl py-[40px] px-[10px] w-[18rem] rounded-[10px]">
        ...
        <div className="relative z-1 flex flex-col items-center border-[2px] border-gray-300 shadow-xl py-[40px] px-[10px] w-[18rem] rounded-[10px]">
